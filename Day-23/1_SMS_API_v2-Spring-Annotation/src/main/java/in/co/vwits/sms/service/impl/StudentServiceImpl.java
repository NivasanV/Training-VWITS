...
public class StudentServiceImpl implements StudentService {
	...
	@Autowired // to auto inject constructor
	public StudentServiceImpl(StudentDao dao) {
		// this is stop the tight coupling
