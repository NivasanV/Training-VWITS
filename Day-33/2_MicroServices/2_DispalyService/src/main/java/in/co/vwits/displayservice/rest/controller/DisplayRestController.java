...
import in.co.vwits.displayservice.feignclient.MessageServiceOpenFeignClient;
...
public class DisplayRestController {
	...
	@Autowired
	private MessageServiceOpenFeignClient client;
//	@Autowired
//	private RestTemplate rt;
	
	@GetMapping
	// in following annotation fallback method os custom we have created
	// name can be any logical name which we using in application.properties while
	// doing configuration
	@CircuitBreaker(fallbackMethod = "handleError", name = "msgService")
	public String getMessage() {
		...
		String msg = client.remoteGetMethod();
